...
/**
 * This class represents a test output that fails.
 */
public class FailingTestOutput implements Appendable {
  /**
  ...
  public Appendable append(CharSequence csq) throws IOException {
    throw new IOException("Writing to output stream failed.");
  }
