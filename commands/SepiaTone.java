...
/**
 * This class represents a Sepia Tone command that can be performed on an object of an
 * image model.
 */
public class SepiaTone extends AbstractTransformationCommand {
  /**
   * Constructs a Sepia Tone command using a given output, map of image models,
   * and scanner.
   *
   ...
   */
  public SepiaTone(Appendable output, ImageModelMap imageModelMap,
  ...
  protected ImageModel newModel(ImageModel oldModel) {
    return transform(oldModel, Transformation.SEPIA);
  }
}
